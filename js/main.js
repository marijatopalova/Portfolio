...
function ScrollDownToAboutSection() {
  document.getElementById('about_section').scrollIntoView({behavior: "smooth"});
}

function ScrollDownToProjectsSection() {
  document.getElementById('projects_section').scrollIntoView({behavior: "smooth"});
}

function ScrollDownToTechnologies() {
  document.getElementById('technologies_section').scrollIntoView({behavior: "smooth"});
}
